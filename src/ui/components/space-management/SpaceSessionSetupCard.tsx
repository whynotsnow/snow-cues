...
import { ActionGroup, Button, Card, SectionHeader, TextField } from "../../design-system";
...
export function SpaceSessionSetupCard({ controller }: SpaceSessionSetupCardProps) {
  const { currentSpaceIsTemporary, migrationBatches, handleStartSpaceSession } = controller;
    ...
    <Card aria-label="设置空间主密码">
      ...
      <div className="form-stack">
        ...
        <ActionGroup variant="tool">
          <Button disabled={!spaceMasterPassword.trim()} onClick={() => void submitSpaceMasterPassword()}>
            建立空间会话
          </Button>
        </ActionGroup>
      </div>
